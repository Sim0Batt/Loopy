...
//        id: Int
        ...
        try {
            val response = client.get("http://13.61.7.101:8080/getPPG/$id")
...
//        id: Int
        ...
        try {
            val response = client.get("http://13.61.7.101:8080/getElectrodes/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
...
//        id: Int
        ...
        try {
            val response = client.get("http://13.61.7.101:8080/getAccelerometer/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
...
//        id: Int
        ...
        try {
            val response = client.get("http://13.61.7.101:8080/getTermometer/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
