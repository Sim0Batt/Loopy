...
class GetStatusTool : ToolSet {
    ...
    suspend fun getHeartInformations(
        ...
        try {
            val response = client.get("http://13.60.184.192:8080/getPPG/$id")
    ...
    suspend fun getElectrodeInformations(
        ...
        try {
            val response = client.get("http://13.60.184.192:8080/getElectrodes/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
    ...
    suspend fun getAccelerometerInformations(
        ...
        try {
            val response = client.get("http://13.60.184.192:8080/getAccelerometer/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
    ...
    suspend fun getTemperatureInformations(
        ...
        try {
            val response = client.get("http://13.60.184.192:8080/getTermometer/$id")
            responseBody = response.bodyAsText()
            println("Response by server: $response")
            println("Server response: $responseBody")
        } catch (e: Exception) {
